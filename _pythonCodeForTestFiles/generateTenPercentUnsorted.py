...
file = open("_tenPctUnsorted_200000Ints.txt", "w+")
...
file = open("_tenPctUnsorted_400000Ints.txt", "w+")
...
file = open("_tenPctUnsorted_600000Ints.txt", "w+")
...
file = open("_tenPctUnsorted_800000Ints.txt", "w+")
